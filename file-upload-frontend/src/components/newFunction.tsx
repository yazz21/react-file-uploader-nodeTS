...
import { ExpandMore } from "./GetAll";

export function newFunction(res: any, expanded: boolean, handleExpandClick: () => void) {
  return <Card sx={{ maxWidth: 345 }} key={res.filename} className="m-4">
    <CardHeader
